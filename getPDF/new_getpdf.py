...
if not os.path.exists("/home/er-ubuntu-1/webScrapping/getPDF/images"):
    os.makedirs("/home/er-ubuntu-1/webScrapping/getPDF/images")
...
# end = 241
    ...
    for i in range(start, end):
        try:
            ...
            if response.status_code == 200:
                ...
                image_path = f'/home/er-ubuntu-1/webScrapping/getPDF/images/image_{section_id}.png'
    ...
    image_path = f'/home/er-ubuntu-1/webScrapping/getPDF/images/'
    ...
    for i in range (start, end):
        ...
        image_path = f'/home/er-ubuntu-1/webScrapping/getPDF/images/image_{i}.png'
